<?php
/**
 * rspl base SVG Icon helper functions
 *
 * @package rspl_base
 */
...
function rspl_theme_get_icon_svg( $icon, $size = 24 ) {
	return RSPL_SVG_Icons::get_svg( 'ui', $icon, $size );
}
...
function rspl_theme_get_social_icon_svg( $icon, $size = 24 ) {
	return RSPL_SVG_Icons::get_svg( 'social', $icon, $size );
}
...
function rspl_theme_get_social_link_svg( $uri, $size = 24 ) {
	return RSPL_SVG_Icons::get_social_link_svg( $uri, $size );
}
